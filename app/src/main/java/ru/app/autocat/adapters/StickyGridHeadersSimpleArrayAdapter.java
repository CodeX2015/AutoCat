...
public class StickyGridHeadersSimpleArrayAdapter<T> extends BaseAdapter implements
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textView = (TextView) convertView.findViewById(R.id.grid_header);
        ...
        // set header text as mark of car
    ...
    private void init(Context context, ArrayList<Car> items, int headerResId, int itemResId) {
        this.mItems = items;
